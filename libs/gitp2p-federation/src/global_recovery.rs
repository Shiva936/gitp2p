use crate::discovery::discover_replicas;
use gitp2p_core::{Repo, Result};
use crate::build_global_route;
use gitp2p_core::App;

use gitp2p_sync::recovery::multi::recover_from_best_peer;
...
pub fn discover_recovery_sources(
    ...
    for candidate in gitp2p_sync::recovery::multi::select_recovery_source(app, repo_id, "auto")? {
