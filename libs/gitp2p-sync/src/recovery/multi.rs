use gitp2p_core::{read_kv, Checkpoint, Result};
use gitp2p_core::git::git_fsck_ok;
use gitp2p_core::optional_field;
use gitp2p_core::trust::verify_checkpoint;
...
pub fn select_recovery_source(
    ...
    for peer_id in peer_ids {
        ...
        let checkpoint = gitp2p_core::latest_checkpoint(&remote_app, repo_id)?;
...
fn replication_state_for(
    ...
    Err(gitp2p_core::AppError::new("replication state not found"))
}
